...
;
comment on column public.dim_date."date_dim_id" is 'unique identifier for each row';
comment on column public.dim_date."date_actual" is 'actual date in iso 8601 format, yyyy-mm-dd';
comment on column public.dim_date."epoch" is 'epoch value for each date';
comment on column public.dim_date."day_name" is 'the name of the day in english';
comment on column public.dim_date."day_of_week_1" is 'day calculation on beginning and end of month based on day of month. the rest use iso 8601, starting day from monday to sunday';
comment on column public.dim_date."day_of_week_2" is 'day calculation on beginning and end of month based on day of month. the rest based on iso 8601, starting day from sunday to saturday';
comment on column public.dim_date."day_of_week_3" is 'iso 8601, starting day from monday to sunday';
comment on column public.dim_date."day_of_week_4" is 'starting day from sunday to saturday';
comment on column public.dim_date."day_of_month_1" is 'calculation start from date one of the month';
comment on column public.dim_date."day_of_month_2" is 'calculation start from the first date of the month first week. week calculation based on iso 8601 week of year.';
comment on column public.dim_date."day_of_month_3" is 'calculation start from the first date of the month first week. week calculation based on iso 8601 week of year but first day is sunday';
comment on column public.dim_date."day_of_quarter_1" is 'calculation star from the first date of the quarter';
comment on column public.dim_date."day_of_quarter_2" is 'calculation start from the first date of the quarter first week. week calculation based on iso 8601 week of year';
comment on column public.dim_date."day_of_quarter_3" is 'calculation start from the first date of the quarter first week. week calculation based on iso 8601 week of year but first day is sunday';
comment on column public.dim_date."day_of_year_1" is 'calculation start from the first january of the year';
comment on column public.dim_date."day_of_year_2" is 'calculation start from the first date of the year first week. week calculation using iso 8601 week of year';
comment on column public.dim_date."day_of_year_3" is 'calculation start from the first date of the year first week. week calculation based on iso 8601 but first day is sunday';
comment on column public.dim_date."week_of_month_1" is 'calculation start from day one of the month with starting day from monday. the beginning and the end of the month counted as 1 week eventhough the day count less then seven';
comment on column public.dim_date."week_of_month_2" is 'calculation start from day one of the month with starting day from sunday. the beginning and the end of the month counted as 1 week eventhough the day count less then seven';
comment on column public.dim_date."week_of_month_3" is 'calculation based on iso 8601 week of year, starting day from monday';
comment on column public.dim_date."week_of_month_4" is 'calculation based on iso 8601 week of year, starting day from sunday';
...
comment on column public.dim_date."week_of_quarter_1" is 'calculation start from day one of the quarter with starting day from monday. the beginning and the end of the quarter counted as 1 week eventhough the day count less then seven';
comment on column public.dim_date."week_of_quarter_2" is 'calculation start from day one of the quarter with starting day from sunday. the beginning and the end of the quarter counted as 1 week eventhough the day count less then seven';
comment on column public.dim_date."week_of_quarter_3" is 'calculation based on iso 8601 week of year, starting day from monday';
comment on column public.dim_date."week_of_quarter_4" is 'calculation based on iso 8601 week of year, starting day from sunday';
comment on column public.dim_date."week_of_quarter_5" is 'week increased every seven days and started from day one of the quarter';
comment on column public.dim_date."week_of_year_1" is 'calculation start from day one of the year with starting day from monday. the beginning and the end of the year counted as 1 week eventhough the day count less then seven';
comment on column public.dim_date."week_of_year_2" is 'calculation start from day one of the year with starting day from sunday. the beginning and the end of the year counted as 1 week eventhough the day count less then seven';
comment on column public.dim_date."week_of_year_3" is 'iso 8601 week of year, starting day from monday';
comment on column public.dim_date."week_of_year_4" is 'calculation based on iso 8601 week of year, starting day from sunday';
comment on column public.dim_date."week_of_year_5" is 'week increased every seven days and started from day one of the year';
comment on column public.dim_date."month_actual_name" is 'month actual name';
comment on column public.dim_date."month_of_quarter_1" is 'calculation based on real month';
comment on column public.dim_date."month_of_quarter_2" is 'calculation of beginning and end of the month based on iso 8601 week of year with starting day from monday';
comment on column public.dim_date."month_of_quarter_3" is 'calculation of beginning and end of the month based on iso 8601 week of year with starting day from sunday';
comment on column public.dim_date."month_of_year_1" is 'real month number';
comment on column public.dim_date."month_of_year_2" is 'calculation of beginning and end of the month based on iso 8601 week of year with starting day from monday';
comment on column public.dim_date."month_of_year_3" is 'calculation of beginning and end of the month based on iso 8601 week of year with starting day from sunday';
comment on column public.dim_date."quarter_1" is 'calculation based on real month';
comment on column public.dim_date."quarter_2" is 'calculation of beginning and end of the quarter based on iso 8601 week of year with starting day from monday';
comment on column public.dim_date."quarter_3" is 'calculation of beginning and end of the quarter based on iso 8601 week of year with starting day from sunday';
comment on column public.dim_date."year_actual" is 'real year number';
comment on column public.dim_date."first_day_of_week_1" is 'first date based on calculation of column day_of_week_1';
comment on column public.dim_date."last_day_of_week_1" is 'last date based on calculation of column day_of_week_1';
comment on column public.dim_date."first_day_of_week_2" is 'first date based on calculation of column day_of_week_2';
comment on column public.dim_date."last_day_of_week_2" is 'last date based on calculation of column day_of_week_2';
comment on column public.dim_date."first_day_of_week_3" is 'first date based on calculation of column day_of_week_3';
comment on column public.dim_date."last_day_of_week_3" is 'last date based on calculation of column day_of_week_3';
comment on column public.dim_date."first_day_of_week_4" is 'first date based on calculation of column day_of_week_4';
comment on column public.dim_date."last_day_of_week_4" is 'last date based on calculation of column day_of_week_4';
comment on column public.dim_date."first_day_of_month_1" is 'first date based on calculation of column day_of_month_1';
comment on column public.dim_date."last_day_of_month_1" is 'last date based on calculation of column day_of_month_1';
comment on column public.dim_date."first_day_of_month_2" is 'first date based on calculation of column day_of_month_2';
comment on column public.dim_date."last_day_of_month_2" is 'last date based on calculation of column day_of_month_2';
comment on column public.dim_date."first_day_of_month_3" is 'first date based on calculation of column day_of_month_3';
comment on column public.dim_date."last_day_of_month_3" is 'last date based on calculation of column day_of_month_3';
comment on column public.dim_date."first_day_of_quarter_1" is 'first date based on calculation of column day_of_quarter_1';
comment on column public.dim_date."last_day_of_quarter_1" is 'last date based on calculation of column day_of_quarter_1';
comment on column public.dim_date."first_day_of_quarter_2" is 'first date based on calculation of column day_of_quarter_2';
comment on column public.dim_date."last_day_of_quarter_2" is 'last date based on calculation of column day_of_quarter_2';
comment on column public.dim_date."first_day_of_quarter_3" is 'first date based on calculation of column day_of_quarter_3';
comment on column public.dim_date."last_day_of_quarter_3" is 'last date based on calculation of column day_of_quarter_3';
comment on column public.dim_date."first_day_of_year_1" is 'first date based on calculation of column day_of_year_1';
comment on column public.dim_date."last_day_of_year_1" is 'last date based on calculation of column day_of_year_1';
comment on column public.dim_date."first_day_of_year_2" is 'first date based on calculation of column day_of_year_2';
comment on column public.dim_date."last_day_of_year_2" is 'last date based on calculation of column day_of_year_2';
comment on column public.dim_date."first_day_of_year_3" is 'first date based on calculation of column day_of_year_3';
comment on column public.dim_date."last_day_of_year_3" is 'last date based on calculation of column day_of_year_3';
comment on column public.dim_date."total_day_of_month_1" is 'total day based on column day_of_month_1';
comment on column public.dim_date."total_day_of_month_2" is 'total day based on column day_of_month_2';
comment on column public.dim_date."total_day_of_month_3" is 'total day based on column day_of_month_3';
comment on column public.dim_date."total_day_of_quarter_1" is 'total day based on column day_of_quarter_1';
comment on column public.dim_date."total_day_of_quarter_2" is 'total day based on column day_of_quarter_2';
comment on column public.dim_date."total_day_of_quarter_3" is 'total day based on column day_of_quarter_3';
comment on column public.dim_date."total_day_of_year_1" is 'total day based on column day_of_year_1';
comment on column public.dim_date."total_day_of_year_2" is 'total day based on column day_of_year_2';
comment on column public.dim_date."total_day_of_year_3" is 'total day based on column day_of_year_3';
comment on column public.dim_date."total_week_of_month_1" is 'total week based on column week_of_month_1';
comment on column public.dim_date."total_week_of_month_2" is 'total week based on column week_of_month_2';
comment on column public.dim_date."total_week_of_month_3" is 'total week based on column week_of_month_3';
comment on column public.dim_date."total_week_of_month_4" is 'total week based on column week_of_month_4';
comment on column public.dim_date."total_week_of_month_5" is 'total week based on column week_of_month_5';
comment on column public.dim_date."total_week_of_quarter_1" is 'total week based on column week_of_quarter_1';
comment on column public.dim_date."total_week_of_quarter_2" is 'total week based on column week_of_quarter_2';
comment on column public.dim_date."total_week_of_quarter_3" is 'total week based on column week_of_quarter_3';
comment on column public.dim_date."total_week_of_quarter_4" is 'total week based on column week_of_quarter_4';
comment on column public.dim_date."total_week_of_quarter_5" is 'total week based on column week_of_quarter_5';
comment on column public.dim_date."total_week_of_year_1" is 'total week based on column week_of_year_1';
comment on column public.dim_date."total_week_of_year_2" is 'total week based on column week_of_year_2';
comment on column public.dim_date."total_week_of_year_3" is 'total week based on column week_of_year_3';
comment on column public.dim_date."total_week_of_year_4" is 'total week based on column week_of_year_4';
comment on column public.dim_date."total_week_of_year_5" is 'total week based on column week_of_year_5';
comment on column public.dim_date."is_weekend" is 'weekend on saturday and sunday';
comment on column public.dim_date."is_leap_year" is 'iso 8601 leap year calculation';
